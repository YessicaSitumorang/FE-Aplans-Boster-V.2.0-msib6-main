  ...
  return (
    <Container className="px-[120px]">
      ...
      <div className="grid grid-cols-2 gap-x-[85px] gap-y-10 mt-10">
        <CardSub title={'Anak Anak'} subTitle={'Children'} href={'/data-penerima/rehabsos/anak'} />
        <CardSub title={'Disabilitas'} subTitle={'Disability'} href={'/data-penerima/rehabsos/disab'} />
