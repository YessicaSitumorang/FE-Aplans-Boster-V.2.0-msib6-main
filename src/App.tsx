...
import DataAnak from './pages/DataPenerima/Rehabsos/DataAnak'
import DataKPO from './pages/DataPenerima/Rehabsos/DataKPO'
import DataDisab from './pages/DataPenerima/Rehabsos/DataDisab'
            ...
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/data-penerima">
                ...
                <Route path="rehabsos">
                  ...
                  <Route path="anak">
                    <Route index element={<DataAnak />} />
                    <Route path="create" element={<Djp />} />
                    <Route path="create/:id" element={<Djp />} />
                  </Route>
                  <Route path="kpo">
                    <Route index element={<DataKPO />} />
                    <Route path="create" element={<Djp/>} />
                    <Route path="create/:id" element={<Djp />} />
                  </Route>
                  <Route path ="disab">
                    <Route index element={<DataDisab />} />
                    <Route path="create" element={<Djp/>} />
                    <Route path="create/:id" element={<Djp />} />
                  </Route>
                </Route>
